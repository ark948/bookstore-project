    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fa_name', models.CharField(blank=True, default='', max_length=128, verbose_name='Name (fa)')),
                ('en_name', models.CharField(blank=True, default='', max_length=128, verbose_name='Name (en)')),
        ...
        migrations.CreateModel(
            name='Author',
            fields=[
                ('contributor_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.contributor')),
                ('nationality', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='authors', to='shop.country', verbose_name='Nationality')),
            ],
            bases=('shop.contributor',),
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
